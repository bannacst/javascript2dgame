...
const background = new Sprite({
    ...
    imageSrc: './background/background.png'
})
...
sprites:
{
    ...
    takeHit : {
        imageSrc : './kenji/kenji/Take hit.png',
        framesMax : 3
    },
    death : {
        imageSrc: './kenji/kenji/Death.png',
        framesMax : 7
    }
},
attackBox:{
...
function animate() {
    ...
    //detect player collision and enemy is hit
    ...
    //detect enemy collision and player gets hit
    ...
    //end the game based on the health
...
window.addEventListener('keydown', (event) => {
    ...
    if(!player.dead){
        ...
        if(enemy.dead || player.dead || timer == 0)
        {
            switch(event.key)
            {
                case 'c':
